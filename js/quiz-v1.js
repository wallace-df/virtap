...
function processarQuizAtuante(area, dor) {
    const btnPlataforma = `<button class="next-btn" onclick="window.location.href=getLink('/vagas-assistente-virtual/como-acessar', 'plataforma-vagas', state)">👉 Conheça a Plataforma de Vagas</button>`;
